...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary-900/20 via-primary-800/30 to-secondary-900/20">
      ...
      <div className="container-custom relative z-10 text-center text-white">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium">Academia #1 en Mendoza</span>
          </motion.div>
          ...
          >
            <span className="text-gradient">Pole Fusion</span>
            <br />
            <span className="text-white">Fuerza, arte y libertad</span>
          </motion.h1>
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="btn-outline text-lg px-8 py-4 flex items-center space-x-2 bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white hover:text-primary-500"
            >
              <Play size={20} />
              <span>Ver video</span>
            </motion.button>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">Alumnas felices</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">Clases por semana</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
